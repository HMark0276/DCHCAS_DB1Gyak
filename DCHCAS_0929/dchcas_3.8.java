...
public class DCHCAS_38 {

	private static DCHCAS_38 adatok[];
	...
	public DCHCAS_38(String aznosito, String nev) {
		this.aznosito = aznosito;
		this.nev = nev;
	}
	...
	public static DCHCAS_38[] beker(DCHCAS_38[] adatok, Scanner sc) throws IOException {
		...
		for (int i = 0; i < adatok.length; i++) {
			...
			adatok[i] = new DCHCAS_38(azonosito, nev);
			ossz++;
	...
	public static void torles(DCHCAS_38[] adatok, Scanner sc) throws IOException {
	...
	public static void modosit(DCHCAS_38[] adatok, Scanner sc) throws IOException {
